 ...
 * @throws Exception
 */
function getDayTemplateByOdds($regularRate, $extraRate, $lazyRate): array
{
    $regularDayTemplate = [
        'time1' => '08:00',
        'time2' => '12:00',
 ...
 * @throws Exception
 */
function populateWorkingHours($userId, $initialDate, $regularRate, $extraRate, $lazeRate) {
    ...
    while (isBefore($currentDate, $yesterday)) {
        if (!isWeekend($currentDate)) {
            $template = getDayTemplateByOdds($regularRate, $extraRate, $lazeRate);
